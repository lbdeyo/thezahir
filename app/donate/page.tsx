...
const FOUNDING_DONORS = [
  ...
  "William Deyo",
  "Debbie Deyo-Howe",
  "Stephanie and Russ Deyo",
  "John and Nancy Masterson",
  "Jason Neulander",
  "Elizabeth and Rick Bowerman",
];
...
function DonateContent() {
  ...
  const [foundingCustomAmount, setFoundingCustomAmount] = useState("");
  const [isFoundingProcessing, setIsFoundingProcessing] = useState(false);
  ...
  const handleFoundingDonation = (amount: number) => {
    startCheckout(CUSTOM_DONATION_PRICE_ID, {
      customAmount: amount.toString(),
    });
  };

  const handleFoundingCustomDonation = async () => {
