            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="flex items-center text-2xl text-[#ada173] font-medium font-['Baskerville']">
                  ...
                  <span>Stephanie and Russ Deyo</span>
                </div>
                <div className="flex items-center text-2xl text-[#ada173] font-medium font-['Baskerville']">
                  <svg
                    className="w-6 h-6 mr-3 shrink-0"
                  ...
                  <span>John and Nancy Masterson</span>
                </div>
                <div className="flex items-center text-2xl text-[#ada173] font-medium font-['Baskerville']">
                  <svg
                    className="w-6 h-6 mr-3 shrink-0"
                ...
                <div className="flex items-center text-2xl text-[#ada173] font-medium font-['Baskerville']">
                  ...
                  <span>Elizabeth and Rick Bowerman</span>
                </div>
              </div>
            </div>
          </div>
